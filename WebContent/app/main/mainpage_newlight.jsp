					...
					<ul class="menu">
						...
						<div class="category-menu-1 width">
							<li class="menu-list"><a
								href="/creations/pageListOk.ct?categoryCode=101&categoryName=폰트"
								class="menu-list-1"> <strong class="font-name">손글씨<span
										class="font-size">(Font)</span></strong> <img
									src="${pageContext.request.contextPath}/assets/img/main/fontCategory.png"
									class="handpen-img" />
							</a></li>
						</div>
						...
						<div class="category-menu-2 width">
							<li class="menu-list"><a
								...
								class="menu-list-2"> <strong class="background-name">배경화면</strong>
									<img
						...
						<div class="category-menu-3 width">
							<li class="menu-list"><a
								...
								class="menu-list-3"> <img
									src="${pageContext.request.contextPath}/assets/img/main/tracingCategory.png"
									class="tracing-img" /> <strong class="tracing-name">트레이싱</strong>
							</a></li>
						</div>
						...
						<div class="category-menu-5 width">
							<li class="menu-list"><a
								...
								class="menu-list-5"> <strong class="animation-name">만화</strong>
									<img
				...
				<div class="category-create-container">
					...
					<ul class="create-list">
						...
						<c:forEach var="content" items="${main}">
							...
							<c:if
								test="${content.getCategoryName() == '배경화면' || content.categoryName== '트레이싱' }">
												...
												<a href="#" class="a__inline-block">
													<div class="icon-like">
														<img
															...
															class="like-icon-img" /> <span class="count"><c:out
																value="${content.getLikeCount() }" /></span>
													</div>
												</a> <a href="${pageContext.request.contextPath}"
													class="a__inline-block">
													<div class="icon-comment">
														<img
															src="${pageContext.request.contextPath}/assets/img/member/reply.png"
															class="reply-icon-img" /> <span class="count"><c:out
																value="${content.getCommentCount() }" /></span>
													</div>
												</a>
											</div>
										</div>
							...
							<c:if
								test="${content.categoryName== '손그림' || content.categoryName== '카톡테마' || content.categoryName== '폰트' || content.categoryName== '만화' }">
