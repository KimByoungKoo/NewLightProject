						...
						<div class="tabs-stage">
							<div id="tab-2">
								<label class="user-name">이름 </label> <input class="txt name"
									type="text" id="name" placeholder="이름을 입력해 주세요" name="memberName">
									<span calss="check-msg" id="check-name-msg"></span>
								<br> <label class="user-phone">휴대폰 번호</label> <input
									type="tel" id="phone" class="phone" placeholder="휴대폰 번호를 입력해주세요"
									maxlength="11" name="memberPhoneNumber">
									<span calss="check-msg" id="check-phone-msg"></span>
